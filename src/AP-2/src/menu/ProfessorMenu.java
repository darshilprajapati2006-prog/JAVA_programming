...
public class ProfessorMenu {
    ...
    private void handleViewCourseFeedback() {
        String courseCode = inputUtil.readLine("Enter course code: ");
        List<Feedback<?>> feedbackEntries = professorService.viewCourseFeedback(professor, courseCode);
        System.out.println();
        if (feedbackEntries.isEmpty()) {
            System.out.println("No feedback found for this course or access denied.");
        } else {
