...
public class SeedData {
    ...
    private static final String DEFAULT_TA_PASSWORD = "TA@123";
    private static final Map<String, double[]> REPORTED_FIRST_SEM_RESULTS = createReportedFirstSemResults();
    ...
    public static String getDemoSummary() {
        return """
                ...
                - Students seeded: 63
                - Professors seeded: 9
                - Teaching assistants seeded: 1
                - Administrators seeded: 1
                - Courses seeded: 53
                - Complaints seeded: 8

                Recommended Accounts:
                - Student: i25ai001@students.aid.svnit.ac.in / Student@123
                - Professor: rahulshrivastava@aid.svnit.ac.in / Prof@123
                - Teaching Assistant: ta001@students.aid.svnit.ac.in / TA@123
    ...
    public static void initialize(UniversityDataStore dataStore) {
        ...
        seedTeachingAssistants(dataStore);
    ...
    private static void seedTeachingAssistants(UniversityDataStore dataStore) {
        TeachingAssistant teachingAssistant = new TeachingAssistant(
                "TA001",
                "Aarav Mehta",
                "ta001@students.aid.svnit.ac.in",
                DEFAULT_TA_PASSWORD,
                DEPARTMENT,
                "TA-A01",
                "TAI25AI001",
        ...
        teachingAssistant.assignCourseForAssistance("IA102");
        teachingAssistant.assignCourseForAssistance("IA101");
    ...
    private static void seedAllStudents(UniversityDataStore dataStore) {
        for (int index = 0; index < STUDENT_ROSTER.length; index++) {
            ...
            Student student = new Student(
                    ...
                    DIVISION,
                    2);
            applyReportedFirstSemesterResult(student);
    ...
    private static void seedCoursesBySemester(UniversityDataStore dataStore) {
        addCourse(dataStore, course("IA101", "Introduction to Artificial Intelligence", "Dr. Rahul Shrivastava", 4, 1,
        ...
        assignProfessor(dataStore, "PROF007", "IA101", "IA102", "IA209", "IA210", "IA4DD", "IA410");
    ...
    private static void seedEnrollmentsAndGrades(UniversityDataStore dataStore) {
        ...
        TeachingAssistant teachingAssistant = dataStore.findTeachingAssistantById("TA001");
        if (teachingAssistant != null) {
            seedCompletedCourse(teachingAssistant, "MA105", 1, "AB");
            seedCompletedCourse(teachingAssistant, "MA116", 1, "AA");
            seedCompletedCourse(teachingAssistant, "HS110", 1, "BB");
            seedCompletedCourse(teachingAssistant, "EE103", 1, "AB");
            seedCompletedCourse(teachingAssistant, "IA101", 1, "AA");
            registerSeedCourse(dataStore, teachingAssistant, "MA106");
        }
    }
    ...
    private static void applyReportedFirstSemesterResult(Student student) {
        double[] result = REPORTED_FIRST_SEM_RESULTS.get(student.getAdmissionNumber().toUpperCase());
        if (result == null) {
            return;
        }

        student.setReportedSgpa(1, result[0]);
        student.setReportedCgpa(result[1]);
    }

    private static Map<String, double[]> createReportedFirstSemResults() {
        Map<String, double[]> results = new HashMap<>();
        results.put("I25AI001", new double[] {6.50, 6.50});
        results.put("I25AI002", new double[] {7.65, 7.65});
        results.put("I25AI003", new double[] {8.55, 8.55});
        results.put("I25AI004", new double[] {0.00, 0.00});
        results.put("I25AI005", new double[] {6.80, 6.80});
        results.put("I25AI006", new double[] {8.65, 8.65});
        results.put("I25AI007", new double[] {7.70, 7.70});
        results.put("I25AI008", new double[] {6.70, 6.70});
        results.put("I25AI009", new double[] {6.40, 6.40});
        results.put("I25AI010", new double[] {7.30, 7.30});
        results.put("I25AI011", new double[] {7.05, 7.05});
        results.put("I25AI012", new double[] {6.75, 6.75});
        results.put("I25AI013", new double[] {7.50, 7.50});
        results.put("I25AI014", new double[] {9.00, 9.00});
        results.put("I25AI016", new double[] {8.40, 8.40});
        results.put("I25AI017", new double[] {8.35, 8.35});
        results.put("I25AI018", new double[] {8.00, 8.00});
        results.put("I25AI020", new double[] {7.10, 7.10});
        results.put("I25AI021", new double[] {5.40, 6.75});
        results.put("I25AI022", new double[] {8.60, 8.60});
        results.put("I25AI023", new double[] {6.40, 6.40});
        results.put("I25AI024", new double[] {8.45, 8.45});
        results.put("I25AI026", new double[] {6.30, 6.30});
        results.put("I25AI027", new double[] {8.25, 8.25});
        results.put("I25AI028", new double[] {9.30, 9.30});
        results.put("I25AI029", new double[] {8.55, 8.55});
        results.put("I25AI030", new double[] {7.65, 7.65});
        results.put("I25AI031", new double[] {7.50, 7.50});
        results.put("I25AI032", new double[] {9.70, 9.70});
        results.put("I25AI033", new double[] {7.45, 7.45});
        results.put("I25AI034", new double[] {7.90, 7.90});
        results.put("I25AI035", new double[] {5.35, 5.35});
        results.put("I25AI036", new double[] {9.00, 9.00});
        results.put("I25AI037", new double[] {8.90, 8.90});
        results.put("I25AI038", new double[] {6.50, 6.50});
        results.put("I25AI039", new double[] {8.30, 8.30});
        results.put("I25AI040", new double[] {9.35, 9.35});
        results.put("I25AI041", new double[] {7.30, 7.30});
        results.put("I25AI042", new double[] {7.85, 7.85});
        results.put("I25AI043", new double[] {9.80, 9.80});
        results.put("I25AI044", new double[] {7.80, 7.80});
        results.put("I25AI045", new double[] {6.75, 6.75});
        results.put("I25AI046", new double[] {7.80, 7.80});
        results.put("I25AI047", new double[] {7.20, 7.20});
        results.put("I25AI048", new double[] {9.00, 9.00});
        results.put("I25AI049", new double[] {8.00, 8.00});
        results.put("I25AI050", new double[] {7.20, 7.20});
        results.put("I25AI051", new double[] {9.80, 9.80});
        results.put("I25AI052", new double[] {7.15, 7.15});
        results.put("I25AI053", new double[] {7.90, 7.90});
        results.put("I25AI054", new double[] {6.35, 6.35});
        results.put("I25AI055", new double[] {8.30, 8.30});
        results.put("I25AI056", new double[] {8.65, 8.65});
        results.put("I25AI057", new double[] {9.10, 9.10});
        results.put("I25AI058", new double[] {7.65, 7.65});
        results.put("I25AI059", new double[] {8.30, 8.30});
        results.put("I25AI060", new double[] {7.05, 7.05});
        results.put("I25AI061", new double[] {6.45, 6.45});
        results.put("I25AI062", new double[] {1.60, 5.33});
        results.put("I25AI063", new double[] {8.25, 8.25});
        return results;
    }
}
