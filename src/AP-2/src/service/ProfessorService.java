...
public class ProfessorService {
    ...
    public ProfessorService(UniversityDataStore dataStore, CourseService courseService, FeedbackService feedbackService) {
    ...
    public List<Feedback<?>> viewCourseFeedback(Professor professor, String courseCode) {
        Course course = getAuthorizedCourse(professor, courseCode);
        if (course == null) {
            return new ArrayList<>();
        }
        return feedbackService.viewCourseFeedback(course.getCourseCode());
    }
